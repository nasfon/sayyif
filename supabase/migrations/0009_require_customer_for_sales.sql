-- ============================================================================
-- IMS — Require a customer for every sale
--
-- Previously only credit sales required a customer (create_sale raised
-- 'credit_requires_customer'). Business rule changed: every completed sale must
-- be tied to a customer, regardless of payment method. This migration recreates
-- create_sale so p_customer_id is mandatory for all sales.
-- ============================================================================
